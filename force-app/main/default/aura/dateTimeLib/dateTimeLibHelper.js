...
({
    ...
    getDisplayValue: function(value, config, callback) {
        ...
        //var date = $A.localizationService.parseDateTimeUTC(dateValue, "YYYY-MM-DD", $A.get("$Locale.langLocale"), useStrictParsing);
        ...
        var displayValue = function(convertedDate) {
            ...
            //var formattedDate = $A.localizationService.formatDateUTC(convertedDate, config.format ,$A.get("$Locale.langLocale"));
            ...
            if (config.timeFormat) {
                //formattedTime = $A.localizationService.formatTimeUTC(convertedDate, config.timeFormat,$A.get("$Locale.langLocale"));
